...
<body>
  <header class="col-md-12">
    <nav class="col-md-8 text-center">
      ...
      <ul class="nav col-md-8" id="navigation">
    ...
    <aside class="col-md-4 pull-right">
      <div class="col-md-12">
        <img src="img/medlem-emblem.png" alt="" class="img-responsive pull-right">
      </div>
      ...
      <div id="login" class="col-md-12 pull-right noGutter">
        ...
        <a href="#" class="col-md-12 text-right">Registrér dig her..</a>
      </div>
    </aside>
  </header>
  <main class="container">
    <section class="col-md-12">
      <div id="row1" class="col-md-3 col-xs-6">
        <article class="noGutter mainArticles col-xs-12">
